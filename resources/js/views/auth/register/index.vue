<template>
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 text-white bg-cover bg-center bg-no-repeat relative" style="background-image: url('/images/home/imagen_registrologin.png');">
